...
features_info.txt: information about the feature selection and the method to collect them - Details below

features.txt: 561 rows, 2 columns (feature identifiers, feature names) - Full list below
