...
## Data set information: Human Activity Recognition Using Smartphones Dataset - Version 1.0
...
features_info.txt: information about the variables used on the feature vector - Details below in "Features_info" section

features.txt: 561 rows, 2 columns (feature identifiers, feature names) List of all features - Full list below in "complete list of variables of each feature vector" section
